...
func TestWritesAsThePerson(t *testing.T) {
	...
	entry := map[string]any{kName: "example-service", "componentType": "service", "gen": map[string]any{"language": "go", "flavours": []any{kApp}, "ci": map[string]any{"chartName": "example-service"}}}
